...
!!! warning "主线审计复核中"
    - [Analysis and Design Principles of Microwave Antennas](112-108105114.md)：官方身份是“微波天线分析与设计原理”，不是通用微波工程；没有开放实验或代码。资源清单中的旧 www 主机抓取记录仍为待复核，需要在下一次证据刷新中重抓。
