---
title: "射频、微波与天线"
description: "网络参数、匹配、噪声、接收机、微波电路和天线，明确仪器、频谱法规与功率安全。"
page_type: track
...
- [电磁场与波](../electromagnetics/index.md)
- [电路分析](../circuits/index.md)
- [通信系统](../communications/index.md)
...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Radio Frequency Systems](110-ece-4880.md) | Cornell University | 主课 | 公开材料导读 | 有公开作业或实验 |
| [RF and Millimeter-Wave Circuit Design](111-rf-and-millimeter-wave-circuit-design.md) | Eindhoven University of Technology | 主课 | 公开材料导读 | 部分开放或受限 |
| [Analysis and Design Principles of Microwave Antennas](112-108105114.md) | IIT Kharagpur / NPTEL | 主课 | 公开材料导读 | 部分开放或受限 |
| [Receivers, Antennas, and Signals](113-6-661.md) | MIT | 补充材料 | 公开材料导读 | 有公开作业或实验 |
