---
title: "电子实验与测量"
description: "从面包板、示波器和误差分析到可复现实验报告，建立安全、可靠的动手能力。"
page_type: track
...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Introduction to Electronics, Signals, and Measurement](024-6-071j.md) | MIT | 主课 | 公开材料导读 | 有公开作业或实验 |
| [Real Analog Courses](027-real-analog.md) | Digilent | 主课 | 公开材料导读 | 部分开放或受限 |
| [Hands-On Introduction to Electrical Engineering Lab Skills](025-6-091.md) | MIT | 补充材料 | 公开材料导读 | 有公开作业或实验 |
