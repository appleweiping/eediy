---
title: "传感器与仪器"
description: "传感机理、接口电路、校准、噪声和测量不确定度，要求给出可追溯的测试方法。"
page_type: track
...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Electrical Measurement and Electronic Instruments](136-108105153.md) | IIT Kharagpur / NPTEL | 主课 | 公开材料导读 | 部分开放或受限 |
| [Sensors and Sensor Circuit Design](138-ecea-5340.md) | University of Colorado Boulder | 主课 | 公开材料导读 | 部分开放或受限 |
| [Sensor Technologies: Physics, Fabrication, and Circuits](137-108106193.md) | IISER Bhopal / NPTEL | 补充材料 | 公开材料导读 | 部分开放或受限 |
