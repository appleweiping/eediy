...
[English](../../en/courses/circuits/022-linear-circuits-1.md) · [← 电路分析](index.md)

> Georgia Institute of Technology 的《Linear Circuits 1: DC Analysis》通过视频和一百余道练习强化直流电路分析；练习反馈丰富，但缺少真正的家庭实验闭环。
...
| 资源 | 访问 | 许可 | 状态 | 复核日期 |
|---|---|---|---|---|
| [课程主页](https://www.coursera.org/learn/linear-circuits-dcanalysis) | 注册后访问 | Coursera Terms of Use | 官方页已列出 | 2026-07-28 |

> “官方页已列出”表示核验日从成功访问的官方来源页发现该链接，不保证目标文件在所有地区或账号状态下都能直接打开。访问不代表获得再分发权；下载、改编或公开发布前，应重新核对提供方页面、目标链接及其中第三方材料的许可。

## 实践闭环

### 《Linear Circuits 1: DC Analysis · Georgia Institute of Technology Linear Circuits 1》动态网络模型与容差验证

这是维护者为《Linear Circuits 1: DC Analysis · Georgia Institute of Technology Linear Circuits 1》建议的自学项目，不是课程官方作业。围绕电路分析设计一个含电阻、电容和可选运放的低压网络，比较手算、SPICE 与限流测量，并研究元件容差和饱和失效。
...
课程包含一百多道练习，但没有真正的家庭实验闭环；Coursera 的订阅、试用或预览访问条件可能变化。
