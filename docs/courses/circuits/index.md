...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Circuits and Electronics](021-6-002.md) | MIT | 主课 | 学习者复核（同课另一轮次） | 有公开作业或实验 |
| [Linear Circuits 1: DC Analysis](022-linear-circuits-1.md) | Georgia Institute of Technology | 可替代 | 公开材料导读 | 部分开放或受限 |
| [Linear Circuits 2: AC Analysis](023-linear-circuits-2.md) | Georgia Institute of Technology | 可替代 | 公开材料导读 | 部分开放或受限 |
| [Introduction to Circuits for Electrical and Computer Engineers](028-ece-2100.md) | Cornell University | 补充材料 | 公开材料导读 | 部分开放或受限 |
