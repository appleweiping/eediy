...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Introductory Digital Systems Laboratory](042-6-111.md) | MIT | 主课 | 公开材料导读；后继课程复盘仅作背景 | 有公开作业或实验 |
| [Hardware Acceleration via FPGA](052-ece-5760.md) | Cornell University | 可替代 | 公开材料导读 | 有公开作业或实验 |
| [Digital Systems Laboratory](043-ece-385.md) | University of Illinois Urbana-Champaign | 可替代 | 资料索引；不是完整课程替代 | 未核到公开练习 |
| [Digital Systems Architecture](045-ee-180.md) | Stanford University | 补充材料 | 资料索引；不是完整课程替代 | 未核到公开练习 |
