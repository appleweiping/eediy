...
| 方向 | 课程数 | S 级 | 主线 |
|---|---:|---:|---:|
| [数字信号处理](dsp/index.md) | 9 | 1 | 1 |
| [通信系统](communications/index.md) | 6 | 3 | 3 |
...
| 方向 | 课程数 | S 级 | 主线 |
|---|---:|---:|---:|
| [PCB、EDA 与硬件验证](pcb-eda/index.md) | 2 | 1 | 1 |
| [传感器与仪器](sensors-instrumentation/index.md) | 3 | 0 | 2 |
| [生物医学电子与信号](biomedical/index.md) | 2 | 0 | 1 |
| [综合设计与毕业项目](capstone-practice/index.md) | 3 | 1 | 1 |
