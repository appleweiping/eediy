...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Computation Structures](037-6-004.md) | MIT | 主课 | 公开材料导读 | 有公开作业或实验 |
| [Digital Design and Computer Architecture](038-ddca.md) | ETH Zurich | 可替代 | 公开材料导读 | 有公开作业或实验 |
| [Build a Modern Computer from First Principles: From Nand to Tetris, Part I](039-nand2tetris-i.md) | Hebrew University of Jerusalem | 可替代 | 公开材料导读 | 有公开作业或实验 |
| [Digital Logic and Computer Organization](041-ece-2300.md) | Cornell University | 补充材料 | 资料索引；不是完整课程替代 | 未核到公开练习 |
