...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Single Variable Calculus](001-18-01sc.md) | MIT | 主课 | 公开材料导读 | 部分开放或受限 |
| [Multivariable Calculus](002-18-02sc.md) | MIT | 主课 | 公开材料导读 | 部分开放或受限 |
| [Differential Equations](003-18-03sc.md) | MIT | 主课 | 公开材料导读 | 部分开放或受限 |
| [Linear Algebra](004-18-06sc.md) | MIT | 主课 | 公开材料导读 | 部分开放或受限 |
| [Complex Variables with Applications](005-18-04.md) | MIT | 可替代 | 公开材料导读 | 有公开作业或实验 |
| [Matrix Methods in Data Analysis, Signal Processing, and Machine Learning](009-18-065.md) | MIT | 可替代 | 公开材料导读 | 部分开放或受限 |
| [The Art of Approximation in Science and Engineering](018-6-055j.md) | MIT | 补充材料 | 公开材料导读 | 有公开作业或实验 |
