...
| 课程 | 机构 | 角色 | 编辑证据 | 实践资源 |
|---|---|---|---|---|
| [Introduction to Embedded and Cyber-Physical Systems](060-eecs-149.md) | University of California, Berkeley | 主课 | 公开材料导读 | 部分开放或受限 |
| [Real-Time Embedded Systems Concepts and Practices](063-real-time-embedded-systems-1.md) | University of Colorado Boulder | 可替代 | 公开材料导读 | 部分开放或受限 |
| [Real-Time Embedded Systems Theory and Analysis](064-real-time-embedded-systems-2.md) | University of Colorado Boulder | 可替代 | 公开材料导读 | 部分开放或受限 |
| [Real-Time Mission-Critical Systems Design](065-real-time-embedded-systems-3.md) | University of Colorado Boulder | 可替代 | 公开材料导读 | 部分开放或受限 |
| [Real-Time Project for Embedded Systems](066-real-time-embedded-systems-4.md) | University of Colorado Boulder | 可替代 | 公开材料导读 | 部分开放或受限 |
