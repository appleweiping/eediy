...
description: "Complete a minimum loop through math, circuits, signals, digital systems, electromagnetics, electronics, and one demonstrable project; aggregate the maintainer planning estimates on each course page and recalibrate after a two-week pilot of every course."
page_type: route
---
...
- [Probabilistic Systems Analysis and Applied Probability](../courses/probability-statistics/007-6-041sc.md) — **Elective option**; MIT; Mainline; S
