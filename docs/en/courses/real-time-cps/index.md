...
description: "Scheduling, timing analysis, reliability, and physical feedback with explicit treatment of missed deadlines."
page_type: track
track_id: "track-real-time-cps"
comments: true
---

<!-- generated-by: scripts/generate_course_pages.py; fingerprint: d9364b6e5b4604c9 -->
...
|---|---|---|---|---|
| [Introduction to Embedded and Cyber-Physical Systems](060-eecs-149.md) | University of California, Berkeley | Main course | Public-material guide | Partial or restricted |
| [Real-Time Embedded Systems Concepts and Practices](063-real-time-embedded-systems-1.md) | University of Colorado Boulder | Alternative | Public-material guide | Partial or restricted |
| [Real-Time Embedded Systems Theory and Analysis](064-real-time-embedded-systems-2.md) | University of Colorado Boulder | Alternative | Public-material guide | Partial or restricted |
| [Real-Time Mission-Critical Systems Design](065-real-time-embedded-systems-3.md) | University of Colorado Boulder | Alternative | Public-material guide | Partial or restricted |
| [Real-Time Project for Embedded Systems](066-real-time-embedded-systems-4.md) | University of Colorado Boulder | Alternative | Public-material guide | Partial or restricted |
