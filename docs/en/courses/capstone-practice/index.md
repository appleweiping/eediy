...
<!-- generated-by: scripts/generate_course_pages.py; fingerprint: 552bdb51fed37884 -->
...
1. [Digital Systems Design Using Microcontrollers](057-ece-4760-ece-5730.md)

## Courses

| Course | Institution | Role | Tier | Practice coverage |
|---|---|---|---|---|
| [Digital Systems Design Using Microcontrollers](057-ece-4760-ece-5730.md) | Cornell University | Mainline | S | Complete |
| [ECE Practice and Design](062-ece-3400.md) | Cornell University | Alternative | B | Partial |
| [Autonomous Robot Design Competition](076-6-270.md) | MIT | Supplement | B | Complete |
