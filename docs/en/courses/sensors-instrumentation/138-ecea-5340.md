...
description: "University of Colorado Boulder's Sensors and Sensor Circuit Design develops sensor-interface circuits through videos, practice, labs, and code, with a strong sequence tied to an older PSoC 5LP and Windows toolchain."
page_type: course
---

<!-- generated-by: scripts/generate_course_pages.py; fingerprint: b958b5ced0be93c2 -->

# Sensors and Sensor Circuit Design

[中文](../../../courses/sensors-instrumentation/138-ecea-5340.md) · [← Sensors and Instrumentation](index.md)
...
|---|---|---|---|---|
| [Course home](https://www.coursera.org/learn/sensors-circuit-interface) | Registration required | Coursera Terms of Use | Listed by official page | 2026-07-28 |
