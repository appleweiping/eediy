...
description: "State space, stability, frequency-domain design, estimation, and optimal control with simulation and model mismatch."
page_type: track
...
!!! warning "Check these course materials before starting"
    - [Feedback Systems: An Introduction for Scientists and Engineers](073-cds-101-cds-110.md): The author-maintained second-edition companion provides the open text, examples, exercises, and updated Python figure sources, but it is not a complete current course run; the instructor exercise manual remains restricted.
...
|---|---|---|---|---|
| [Introduction to Linear Dynamical Systems (2008 Archive)](068-ee-263.md) | Stanford University | Main course | Public-material guide | Public assignments or labs |
| [Feedback Systems: An Introduction for Scientists and Engineers](073-cds-101-cds-110.md) | Caltech | Main course — Check material limits | Public-material guide | Partial or restricted |
| [Feedback Systems](067-6-302.md) | MIT | Main course | Public-material guide | Public assignments or labs |
| [Dynamic Systems and Control](069-6-241j.md) | MIT | Alternative | Public-material guide | Partial or restricted |
| [Dynamics of Nonlinear Systems](070-6-243j.md) | MIT | Supplement | Public-material guide | Partial or restricted |
| [Dynamic Programming and Stochastic Control](072-6-231.md) | MIT | Supplement | Public-material guide | Partial or restricted |
| [Multivariable Control Systems](071-6-245.md) | MIT | Supplement | Public-material guide | Partial or restricted |
