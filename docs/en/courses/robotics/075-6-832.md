...
<!-- generated-by: scripts/generate_course_pages.py; fingerprint: 4107c74c9fb89d3f -->

# Underactuated Robotics

[中文](../../../courses/robotics/075-6-832.md) · [← Robotics and Autonomous Systems](index.md)

> MIT's Underactuated Robotics provides a mainline path through current notes, Drake examples, Colab exercises, videos, and code, with assignment feedback as the remaining limitation.
...
|---|---|---|---|---|
| [Course home](https://ocw.mit.edu/courses/6-832-underactuated-robotics-spring-2022) | Open access | CC BY-NC-SA 4.0 for site materials; third-party exclusions may apply | Listed by official page | 2026-07-28 |

> “Listed by official page” means the link was discovered on a successfully fetched official source on the verification date; it does not guarantee that every region or account can open the target directly. Access does not grant redistribution rights. Re-check the provider page, target link, and third-party notices before downloading, adapting, or publishing material.

## Practice loop

### Underactuated Robotics · MIT 6.832: Robot Task Planning and Safe-Degradation Simulation

This is a maintainer-suggested self-study project for Underactuated Robotics · MIT 6.832, not an official course assignment. Complete a perception–planning–control task in simulation for Robotics and Autonomous Systems, quantifying success rate, collision margin, localization error, and safe stop after sensor failure.
...
Current notes, Drake examples, and Colab exercises are strong, but assignment feedback is incomplete.
