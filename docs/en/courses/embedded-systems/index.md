...
|---|---|---|---|---|
| [Computer Systems from the Ground Up](058-cs-107e.md) | Stanford University | Main course | Public-material guide | Public assignments or labs |
| [Embedded Systems: Shape the World](059-ee-319k-volume-1.md) | The University of Texas at Austin | Main course | Public-material guide | Partial or restricted |
