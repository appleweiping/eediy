---
title: "传感、仪器与生物医学电子"
description: "完成带校准、不确定度、隔离/安全分析和信号处理的测量系统；涉及人体时只使用合规数据或受监督实验。"
page_type: route
---
...
完成带校准、不确定度、隔离/安全分析和信号处理的测量系统；涉及人体时只使用合规数据或受监督实验。
...
- [Biomedical Instrumentation](../courses/biomedical/139-102106669.md) — **必修**; IIT Madras / NPTEL; 主线; A
- [Biomedical Signal and Image Processing](../courses/biomedical/140-hst-582j.md) — **可选补充**; MIT; 补充; A

**阶段退出条件：** 仅用公开或合成数据验证一条生理信号处理链，报告信噪比改善、伪迹抑制率和留出集误差；附隔离、隐私、伦理与“不得用于诊断”的逐项检查，不开展未经批准的人体实验。
